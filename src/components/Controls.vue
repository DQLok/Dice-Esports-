...
<!--
  1. Ràng buocj dữ liệu (thuộc tính html) -> v-bind
      1 chiều từ data vào input
  2. Ràng buộc 2 chiều -> v-model
      1 chiều từ data vào input và từ input trở về data
  Nếu như nó ko phải data trực tiếp từ compnent control thì nó ko dc thay đổi
-->
...
export default {
  name: 'controls',
  props: {
    // có thể khai báo 1 prop với nhiều kiểu dữ liệu
